...
interface CardsCarouselProps {
  isSaleSection?: boolean; 
}
export default function CardsCarousel({ isSaleSection = false }: CardsCarouselProps) {
    ...
    <div className='relative w-full flex justify-center items-center overflow-hidden'>
      ...
      >
        {posts.map((product, index) => (
          ...
          <div key={`${product.id}-${index}`} className="flex flex-col w-[281px] h-[300px] relative 2xl:w-[333px] 2xl:h-[390px]">
            <div className='w-[145px] h-[70%] bg-[#EBEFF3] rounded-lg md:w-[230px] xl:w-[240px] 2xl:w-[333px] relative overflow-hidden'>
              <img
              ...
              />
               {isSaleSection && (
                <div className="absolute top-2 left-2 bg-[#F02C961A] text-[#F02C96] text-[10px] md:text-[12px] px-2 py-1 rounded-lg lg:text-[14px]">
                  Aksiyada
                </div>
              )}
              <button
